...
#include "stm32f1xx_hal.h"
  ...
  */
  ...
  #define TIMER2_FREQ_HZ         HAL_RCC_GetPCLK2Freq()
  ...
  #define WS2812_TIMER_PWM_CH1_TIME  (((TIMER2_FREQ_HZ / 1000) *  30) / 100000)
  #define WS2812_TIMER_PWM_CH2_TIME  (((TIMER2_FREQ_HZ / 1000) *  60) / 100000)
